...
if USE_VSCODE == 'y':
    print(
        'In order to have all Terminals with the same theme, you have to set the theme in the settings.json file of VSCode'
    ...
    print(
        'In my opinion, the background color is not always fitting well, do you want me to change it to the basic one from vscode? (y/n)')
